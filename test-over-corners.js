// test-over-corners.js — Aposta OVER 0.5 ESCANTEIOS FT (Odds Asiáticas)
//
// Bots cobertos por este teste:
//   - OVER 0.5 ESCANTEIOS FT - V2.0 / V6.0 / V7.0
//   - OVER CORNER 0.5 FT ODD MIN: 1.7 - 2.0
//   - REVALIDAÇÃO OVER 0.5 CORNERS V2.0 (SEM FILTRO DE LIGAS) -- V1.0
//
// Uso:
//   node test-over-corners.js          → dry run
//   node test-over-corners.js --true   → APOSTA REAL
...
// Offset pode ser fixo aqui pois todos esses bots usam 0.5
const OFFSET         = 0.5;
// ─────────────────────────────────────────────────────────────────────────────
...
async function main() {
  ...
  console.log('🧪 Teste OVER 0.5 ESCANTEIOS FT (asiáticas)\n');
